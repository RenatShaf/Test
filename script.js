let phrases = [
  ...
  { text: 'изучи реп план на ближайший месяц', image: 'https://code.s3.yandex.net/web-code/procrastinate/7.png' },
  { text: 'послушай и нормализуй треки к спектаклям', image: 'https://code.s3.yandex.net/web-code/procrastinate/8.png' },
  { text: 'иди попей чай с салатиком и не мешай мне работать!', image: 'https://www.pngkit.com/png/full/244-2443396_hibiscus-tea-coffee-cup-orange-pu-er-tea.png' },
